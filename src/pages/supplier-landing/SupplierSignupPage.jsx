  ...
  return (
    <>
      <style>{`
        ...
        /* ── Tablette / mobile : le panneau image se masque, le formulaire prend tout ── */
        @media (max-width: 860px) {
          .ss-left  { display: none !important; }
          .ss-root  { height: 100dvh !important; }
          .ss-form  { height: 100dvh !important; }
          .ss-topbar { padding: 14px 18px !important; }
          .ss-inner {
        ...
        /* ── Petits écrans : grilles 2 colonnes → 1 colonne ── */
        @media (max-width: 560px) {
          .ss-grid2 { grid-template-columns: 1fr !important; }
          .ss-connector { width: 18px !important; margin: 0 7px !important; }
          .ss-account-text { font-size: 12px !important; }
        }

        /* ── Très petits écrans : labels du stepper masqués ── */
        @media (max-width: 380px) {
          .ss-step-label { display: none !important; }
          .ss-connector { width: 14px !important; margin: 0 5px !important; }
        }
      `}</style>

      <div className="ss-root" style={{ display: 'flex', height: '100vh', overflow: 'hidden', background: '#fff' }}>

        {/* ── LEFT PANEL ── */}
        <div className="ss-left" style={{ width: '38%', minWidth: 340, maxWidth: 520, position: 'relative', overflow: 'hidden', flexShrink: 0 }}>
          <div style={{
        ...
        {/* ── RIGHT PANEL ── */}
        <div className="ss-form" style={{ flex: 1, height: '100vh', display: 'flex', flexDirection: 'column', overflowY: 'auto', background: '#fff', boxSizing: 'border-box' }}>
          <div className="ss-topbar" style={{
            ...
            <span className="ss-account-text" style={{ color: '#9ca3af', fontSize: 13 }}>
              Déjà un compte ?{' '}
          ...
          <div className="ss-inner" style={{
            ...
            {/* ── STEPPER ── */}
            <div style={{ display: 'flex', alignItems: 'center', marginBottom: '3vh', flexWrap: 'wrap', rowGap: 8 }}>
              {STEPS.map((s, i) => {
                ...
                return (
                  <div key={s.id} style={{ display: 'flex', alignItems: 'center' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                      ...
                      <span className="ss-step-label" style={{ fontSize: 13, fontWeight: active ? 700 : 500, color: active ? '#111827' : done ? '#6b7280' : '#b0b5bf' }}>
                        {s.label}
                      </span>
                    </div>
                    {i < STEPS.length - 1 && (
                      <div className="ss-connector" style={{ width: 36, height: 2, margin: '0 12px', borderRadius: 1, background: done ? C.primary : '#e5e7eb', transition: 'background 0.25s ease' }} />
                    )}
                  </div>
                )
              })}
                ...
                <Field label="Mot de passe" required>
                  <div style={{ position: 'relative' }}>
                    <Input type={showPass ? 'text' : 'password'} value={password}
                      onChange={e => setPassword(e.target.value)} placeholder="Min. 8 caractères" style={{ paddingRight: 44 }} />
            ...
            {step === 2 && (
              <div style={{ display: 'flex', flexDirection: 'column', gap: '1.2vh' }}>
                ...
                <div className="ss-grid2" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 14 }}>
