      ...
      <section style={{
        ...
        <div style={{
          ...
          <h1 style={{
            ...
            Développez votre entreprise et vendez à toute la Tunisie en quelques clics
          </h1>
          ...
          <div className="gh-grid-split" style={{ marginBottom: 'clamp(48px, 7vw, 80px)' }}>
            <div>
              ...
              <h2 style={{
                ...
                {' '}avec la marketplace B2B leader en Tunisie.
              </h2>
            </div>
            ...
            <div style={{ paddingTop: 12 }}>
              <p style={{
                ...
                Vous galérez à toucher les bons acheteurs ? GROSHOP connecte votre marque
                à des milliers de boutiques, épiceries et restaurants partout en Tunisie,
                avec des outils pro et un support local dédié.
              </p>
        ...
        <div style={{ maxWidth: 1200, margin: '0 auto', position: 'relative', zIndex: 1 }}>
          ...
          <div style={{ textAlign: 'center', marginBottom: 'clamp(40px, 6vw, 56px)' }}>
            ...
            <p style={{
              ...
              Rejoignez +500 fournisseurs qui développent leur activité sur GROSHOP.tn
            </p>
          </div>
          ...
          <div style={{
            ...
            <div className="gh-steps-grid">
              <Step
                ...
                description="Inscrivez-vous gratuitement en 2 minutes avec votre email et les infos de votre entreprise."
              />
              <Step
                number="2"
                title="Vérifiez votre entreprise"
                description="Téléchargez vos documents (RNE, CIN, RIB) — validation par notre équipe sous 24h."
              />
              <Step
                number="3"
                title="Commencez à vendre"
                description="Ajoutez vos produits, paramétrez votre boutique, et touchez des milliers d'acheteurs."
              />
            </div>
          </div>
    ...
    <div
      style={{
        background: highlighted
          ? 'linear-gradient(180deg, rgba(255,122,55,0.22) 0%, rgba(20,28,52,0.72) 60%, rgba(15,22,42,0.78) 100%)'
          : 'linear-gradient(180deg, rgba(26,34,58,0.70) 0%, rgba(16,24,44,0.74) 100%)',
        backdropFilter: 'blur(8px)',
        WebkitBackdropFilter: 'blur(8px)',
        border: highlighted
          ? '1px solid rgba(255,122,55,0.55)'
      ...
      <ul style={{
        ...
        {features.map((f, i) => (
          <li key={i} style={{
            ...
            <CheckCircle highlighted={highlighted} />
            <span>{f.text}</span>
          </li>
        ))}
      </ul>
...
// ── ICÔNE CHECK CIRCLE ──
function CheckCircle({ highlighted }) {
  return (
...
function PricingWaves() {
  ...
  return (
    <div aria-hidden="true" style={{
      ...
      WebkitMaskImage: 'linear-gradient(to bottom, transparent 0, #000 130px, #000 calc(100% - 80px), transparent 100%)',
      maskImage: 'linear-gradient(to bottom, transparent 0, #000 130px, #000 calc(100% - 80px), transparent 100%)',
    }}>
      {/* Halo central qui « respire » — centré derrière les cartes */}
      <div className="gh-wave-glow" style={{
        position: 'absolute',
        top: '30%', left: '50%',
        width: '82%', height: '70%',
        background: 'radial-gradient(ellipse at center, rgba(255,122,55,0.26) 0%, rgba(255,90,20,0.08) 42%, transparent 72%)',
        filter: 'blur(24px)',
      }} />

      <svg width="100%" height="100%" viewBox="0 0 1200 760" preserveAspectRatio="xMidYMid slice" style={{ position: 'absolute', inset: 0 }}>
        <defs>
          <radialGradient id="ghRingFade" gradientUnits="userSpaceOnUse" cx="600" cy="470" r="820">
            <stop offset="0"    stopColor={ACCENT}       stopOpacity="0.50" />
            <stop offset="0.5"  stopColor={ACCENT_LIGHT} stopOpacity="0.16" />
            <stop offset="1"    stopColor="#FFFFFF"      stopOpacity="0" />
          </radialGradient>
          <radialGradient id="ghSonarStroke" gradientUnits="userSpaceOnUse" cx="600" cy="470" r="820">
    ...
    <div style={{
      ...
      <svg
        ...
        {gouvernorats.map((g) => {
          ...
          const isCapital = g.name === 'Tunis'
          return (
            <g key={g.id}
              onMouseEnter={() => setHovered(g.id)}
              onMouseLeave={() => setHovered(null)}
              style={{ cursor: 'pointer' }}>
              {/* Base fill avec dots blancs */}
              <path
                d={g.path}
                fill={isHovered ? 'url(#dotPatternHover)' : 'url(#dotPatternGov)'}
                stroke={isHovered ? 'rgba(255,138,80,0.85)' : 'rgba(255,255,255,0.14)'}
              ...
              <path
                ...
                fill={
                  isCapital
                    ? 'rgba(255,122,55,0.20)'
                    : isHovered
                    ? 'rgba(255,122,55,0.28)'
    ...
    <div style={{
      ...
      {chars.map((c, i) => (
        c === ' ' ? (
          ...
          <div key={i} style={{
            width: 36, height: 50,
            background: 'linear-gradient(180deg, #1c2438 0%, #0B1122 100%)',
            borderRadius: 6,
            display: 'flex', alignItems: 'center', justifyContent: 'center',
            color: '#fff',
            fontSize: 28,
...
// ── CARD FLOTTANTE ──
function FloatingCard({ style, avatar, flag, className }) {
  return (
  ...
  return (
    <div
      ...
      onMouseEnter={e => {
        ...
        e.currentTarget.style.borderColor = 'rgba(255,138,80,0.40)'
        e.currentTarget.style.boxShadow = '0 20px 40px rgba(0,0,0,0.30), 0 0 32px rgba(255,122,55,0.16)'
      }}
      onMouseLeave={e => {
        e.currentTarget.style.transform = 'translateY(0)'
      ...
      <div style={{
        ...
        background: 'radial-gradient(circle, rgba(255,122,55,0.22) 0%, transparent 70%)',
        filter: 'blur(20px)',
        pointerEvents: 'none',
      }} />
      ...
      <div style={{
        width: 44, height: 44,
        borderRadius: 12,
        background: 'linear-gradient(135deg, rgba(255,122,55,0.22) 0%, rgba(255,122,55,0.08) 100%)',
        border: '1px solid rgba(255,122,55,0.30)',
        display: 'flex', alignItems: 'center', justifyContent: 'center',
        marginBottom: 24,
        position: 'relative',
        zIndex: 1,
...
function IconGrid() {
  return (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke={ACCENT_LIGHT} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
